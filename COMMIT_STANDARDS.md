...
This document explains how commit standards are enforced both locally and on GitHub for the AWS Network Firewall automation project.

## 🎯 Overview

We enforce commit standards at multiple levels:
- **Local enforcement**: Pre-commit hooks, commit message validation, and branch name validation
- **GitHub enforcement**: PR title validation, commit message validation, and automated checks
...
# Solution: Use the interactive commit helper
npm run commit
```
...
Remember: These standards exist to maintain code quality and make collaboration easier. When in doubt, err on the side of following the standards!