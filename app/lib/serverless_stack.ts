...
export class ServerlessStack extends TaggedStack {
  constructor(scope: Construct, id: string, props: ServerlessProps) {
      ...
      statement: {
        ...
        Condition: {
          'ForAnyValue:StringEquals': {
            'aws:PrincipalOrgID': `${props.organizationIds.toString()}`,
          },
        },
      },
    });
    ...
    s3ObjectEventRule.addTarget(
      new LambdaFunction(ruleCollectLambda, {
